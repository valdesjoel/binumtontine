...
public class ListPlageTEP extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="TEP"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageTEP.this, PlageDataTEP.class);
...
private void loadPlageForCreateTxIntAvancSpec(){
    ...
    try {
        ...
        if (success == 1) {
            ...
            for (int i = 0; i < CreateProduitEAP.plageDataListTEP.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;

                String movieName =  CreateProduitEAP.plageDataListTEP.get(i).getPdValDe()+
                        " - "+ CreateProduitEAP.plageDataListTEP.get(i).getPdValA()+
                        " ( "+ CreateProduitEAP.plageDataListTEP.get(i).getPdValTaux()+" )";
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageTEP.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataTEP.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataTEP.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataTEP.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageTEP.this,
