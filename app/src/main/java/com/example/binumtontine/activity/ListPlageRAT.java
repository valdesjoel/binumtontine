...
public class ListPlageRAT extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="RAT"; //nouveau
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(ListPlageRAT.this, PlageDataRAT.class);
    ...
    private void loadPlageForCreateTxIntAvancSpec(){
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < CreateProduitEAT.plageDataListRAT.size(); i++) {
                    // JSONObject movie = movies.getJSONObject(i);
                    Integer movieId = i;
                    String movieName ="";
                    if (CreateProduitEAT.plageDataListRAT.get(i).getPdNature().equals("F")){
                        movieName = CreateProduitEAT.plageDataListRAT.get(i).getPdValDe()+
                                CreateProduitEAT.plageDataListRAT.get(i).getPdValA()+
                                " ( "+ defaultFormat.format(parseDouble(CreateProduitEAT.plageDataListRAT.get(i).getPdValTaux()))+" )";
                    }else{
                        movieName = CreateProduitEAT.plageDataListRAT.get(i).getPdValDe()+
                                CreateProduitEAT.plageDataListRAT.get(i).getPdValA()+
                                " ( "+ parseDouble(CreateProduitEAT.plageDataListRAT.get(i).getPdValTaux())+" %)";
    ...
    private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ListPlageRAT.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataRAT.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataRAT.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataRAT.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageRAT.this,
