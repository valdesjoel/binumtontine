...
public class ListPlageIRD extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="IRD"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageIRD.this, PlageDataIRD.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                for (int i = 0; i < CreateProduitCpteCourant.plageDataListIRD.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCpteCourant.plageDataListIRD.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCpteCourant.plageDataListIRD.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListIRD.get(i).getPdValA()+
                            defaultFormat.format(parseDouble(CreateProduitCpteCourant.plageDataListIRD.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCpteCourant.plageDataListIRD.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListIRD.get(i).getPdValA()+
                            parseDouble(CreateProduitCpteCourant.plageDataListIRD.get(i).getPdValTaux())+" %)";
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageIRD.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataIRD.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataIRD.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataIRD.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageIRD.this,
