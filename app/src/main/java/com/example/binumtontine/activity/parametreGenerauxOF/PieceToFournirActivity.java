...
public class PieceToFournirActivity extends AppCompatActivity  {
...
/* begin */
      //  setContentView(R.layout.activity_movie_listing);
        ...
        new PieceToFournirActivity.FetchMoviesAsyncTask().execute();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(PieceToFournirActivity.this, CreateProduitEAV.class);
                startActivity(i);
...
private class FetchMoviesAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(PieceToFournirActivity.this);
    ...
    private void populateMovieList() {
        ListAdapter adapter = new SimpleAdapter(
                PieceToFournirActivity.this, movieList,
        ...
        movieListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PieceToFournirActivity.this,
