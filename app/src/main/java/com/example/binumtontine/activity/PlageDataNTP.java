...
public class PlageDataNTP extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="NTP";
   ...
   // public static ArrayList<ModelPlageData> plageDataListCTP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  plageDataListCTP = new ArrayList<>();
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_EpBaseTxIntRupant)); //this is important, you must set it to set the item list
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataNTP.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = ProduitEAP.encodeEpBaseTxIntRupant(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataNTP.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageNTP.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = ProduitEAP.decodeEpBaseTxIntRupant(plageData.getString(KEY_PD_BASE));
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitEAP.plageDataLisNTP.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ...
        CreateProduitEAP.plageDataLisNTP.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitEAP.plageDataLisNTP.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitEAP.plageDataLisNTP.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitEAP.plageDataLisNTP.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitEAP.plageDataLisNTP.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitEAP.plageDataLisNTP.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataNTP.this);
