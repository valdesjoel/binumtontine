...
public class ListPlageIRC extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="IRC"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageIRC.this, PlageDataIRC.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                for (int i = 0; i < CreateProduitCredit.plageDataListIRC.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCredit.plageDataListIRC.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCredit.plageDataListIRC.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListIRC.get(i).getPdValA()+
                            "( " +defaultFormat.format(parseDouble(CreateProduitCredit.plageDataListIRC.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCredit.plageDataListIRC.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListIRC.get(i).getPdValA()+
                            "( "+parseDouble(CreateProduitCredit.plageDataListIRC.get(i).getPdValTaux())+" %)";
...
private class FetchListPlageAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageIRC.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataIRC.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataIRC.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataIRC.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageIRC.this,
