...
import com.example.binumtontine.activity.PlageDataTIC;
...
public class ListAvalisteActivity extends AppCompatActivity implements SERVER_ADDRESS {

    private static final String KEY_SUCCESS = "success";
    private static final String KEY_DATA = "data";
    private static final String KEY_TIC_ID = "Numero";
    private static final String KEY_TIC_LIBELLE = "Libelle";
    ...
    private String pdTypeData="TIC"; //nouveau
...
/* begin */
      //  setContentView(R.layout.activity_movie_listing);
        ...
        getSupportActionBar().setTitle("Liste "+MyData.TYPE_DE_FRAIS_PLAGE_DATA);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Ajouter un avaliste", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListAvalisteActivity.this, PlageDataTIC.class);
...
private class FetchListTxFraisEtudeDossierAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListAvalisteActivity.this);
...
if (IS_TO_CREATE_OR_TO_UPDATE){
    ...
    private void populateMovieListPlageTxFraisEtudeDossier() {
        ListAdapter adapter = new SimpleAdapter(
                ListAvalisteActivity.this, movieList,
        ...
        movieListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(ListAvalisteActivity.this,
