...
public class PlageDataIRA extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="IRA";
   ...
   // public static ArrayList<ModelPlageData> plageDataListIRA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_CcBasexInt_IntRetAvceSpec)); //this is important, you must set it to set the item list
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataIRA.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = CompteCourant.encodeCcBasexInt_IntRetAvceSpec(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataIRA.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageIRA.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                            ...
                            if (ListPlageIRA.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
//                                CreateProduitEAV.plageDataListIRA.remove(Integer.parseInt(plageDataId));
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = CompteCourant.decodeCcBasexInt_IntRetAvceSpec(plageData.getString(KEY_PD_BASE));
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitCpteCourant.plageDataListIRA.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ...
        CreateProduitCpteCourant.plageDataListIRA.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitCpteCourant.plageDataListIRA.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitCpteCourant.plageDataListIRA.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitCpteCourant.plageDataListIRA.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitCpteCourant.plageDataListIRA.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitCpteCourant.plageDataListIRA.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataIRA.this);
