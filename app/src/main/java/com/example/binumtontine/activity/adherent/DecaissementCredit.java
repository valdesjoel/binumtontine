...
public class DecaissementCredit extends AppCompatActivity implements AdapterView.OnItemSelectedListener, SERVER_ADDRESS {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EavDepotMinEditText = (EditText) findViewById(R.id.input_txt_DcDetailsDecaiss);
//        EavDepotMinEditText.addTextChangedListener(MyData.onTextChangedListener(EavDepotMinEditText));

        NumDossierEditText = (EditText) findViewById(R.id.input_txt_DcNumBordDecaiss);
...
*/
    ...
    private void populateSpinner() {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(DecaissementCredit.this,
    ...
    private class GetProduitEAVList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialogFetchProduitEavList = new ProgressDialog(DecaissementCredit.this);
