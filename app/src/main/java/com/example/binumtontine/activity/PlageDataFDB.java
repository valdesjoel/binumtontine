...
public class PlageDataFDB extends AppCompatActivity implements  SERVER_ADDRESS {
   ...
   // public static ArrayList<ModelPlageData> plageDataListCTP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plageDataId = intent.getStringExtra(KEY_FDB_ID);
...
*/
       ...
       if (what_to_do==3 || what_to_do==2){
           new FetchCrFDBDetailsAsyncTask().execute();
       }
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataFDB.this,
...
//            JoMtDemarrEditText.setText(valueNew+"");
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataFDB.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageDataFDBActivity.IS_TO_CREATE_OR_TO_UPDATE){
...
//                                CreateProduitEAV.plageDataListCTP.remove(Integer.parseInt(plageDataId));
     ...
     */
    private class FetchCrFDBDetailsAsyncTask extends AsyncTask<String, String, String> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            //Display progress bar
...
//                    baseEditText.setText(base);
    ...
    private void savePlageForCreateFDB(){
    ...
    private void savePlageForUpdateFDB(){

            HttpJsonParser httpJsonParser = new HttpJsonParser();
            Map<String, String> httpParams = new HashMap<>();
            //Populating request parameters
           // httpParams.put(KEY_FDB_ID, uxGuichetId);
            ...
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "add_fdb_plage_data.php", "POST", httpParams);
        try {
            success = jsonObject.getInt(KEY_SUCCESS);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void updatePlageForUpdate(){
            ...
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "update_tiv_plage_data.php", "POST", httpParams); //Idem pour les plages FDB
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataFDB.this);
        ...
        protected String doInBackground(String... params) {
           ...
           if (ListPlageDataFDBActivity.IS_TO_CREATE_OR_TO_UPDATE){
               savePlageForCreateFDB();
           }else{
               savePlageForUpdateFDB();
           }
            return null;
        }
