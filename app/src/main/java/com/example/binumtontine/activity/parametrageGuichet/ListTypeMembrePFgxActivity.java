...
public class ListTypeMembrePFgxActivity extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    private static final String KEY_CAISSE_ID = "TxGuichet";
...
/* begin */
      //  setContentView(R.layout.activity_movie_listing);
        ...
        new ListTypeMembrePFgxActivity.FetchMoviesAsyncTask().execute();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListTypeMembrePFgxActivity.this, CreateProduitEAV.class);
...
private class FetchMoviesAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListTypeMembrePFgxActivity.this);
    ...
    protected String doInBackground(String... params) {
        ...
        httpParams.put(KEY_CAISSE_ID, String.valueOf(MyData.GUICHET_ID));
        JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                BASE_URL + "fetch_all_type_membre_by_guichet.php", "GET", httpParams);
        try {
    ...
    private void populateMovieList() {
        ListAdapter adapter = new SimpleAdapter(
                ListTypeMembrePFgxActivity.this, movieList,
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            ParametreGenerauxGxActivity.class);
                    intent.putExtra(KEY_GUICHET_ID, movieId);
                    startActivityForResult(intent, 20);

                } else {
                    Toast.makeText(ListTypeMembrePFgxActivity.this,
