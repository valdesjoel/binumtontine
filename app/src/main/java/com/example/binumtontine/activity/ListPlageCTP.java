...
public class ListPlageCTP extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="CTP"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageCTP.this, PlageDataCTP_NEW.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                ...
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCpteCourant.plageDataListCTP.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCpteCourant.plageDataListCTP.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListCTP.get(i).getPdValA()+
                            defaultFormat.format(parseDouble(CreateProduitCpteCourant.plageDataListCTP.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCpteCourant.plageDataListCTP.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListCTP.get(i).getPdValA()+
                            parseDouble(CreateProduitCpteCourant.plageDataListCTP.get(i).getPdValTaux())+" %)";
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageCTP.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataCTP_NEW.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataCTP_NEW.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataCTP_NEW.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageCTP.this,
