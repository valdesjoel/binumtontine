...
public class ListPlageFEC extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="FEC"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageFEC.this, PlageDataFEC_NEW.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                ...
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCredit.plageDataListFEC.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCredit.plageDataListFEC.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListFEC.get(i).getPdValA()+
                            "( " +defaultFormat.format(parseDouble(CreateProduitCredit.plageDataListFEC.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCredit.plageDataListFEC.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListFEC.get(i).getPdValA()+
                            "( "+parseDouble(CreateProduitCredit.plageDataListFEC.get(i).getPdValTaux())+" %)";
...
private class FetchListPlageAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageFEC.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataFEC_NEW.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataFEC_NEW.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataFEC_NEW.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageFEC.this,
