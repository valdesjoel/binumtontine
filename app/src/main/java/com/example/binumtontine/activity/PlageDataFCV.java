...
public class PlageDataFCV extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="FCV";
   ...
   // public static ArrayList<ModelPlageData> plageDataListCTP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_EvBaseFraisCloture)); //this is important, you must set it to set the item list
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataFCV.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = ProduitEAV.encodeEvBaseFraisCloture(mySpinnerBaseTxTIV.getText().toString()) ;
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataFCV.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageFCV.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = ProduitEAV.decodeEvBaseFraisCloture(plageData.getString(KEY_PD_BASE));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitEAV.plageDataListFCV.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ...
        CreateProduitEAV.plageDataListFCV.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitEAV.plageDataListFCV.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitEAV.plageDataListFCV.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitEAV.plageDataListFCV.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitEAV.plageDataListFCV.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitEAV.plageDataListFCV.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataFCV.this);
