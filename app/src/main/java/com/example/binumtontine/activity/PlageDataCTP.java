...
public class PlageDataCTP extends AppCompatActivity implements  SERVER_ADDRESS {
...
//    private static final String KEY_CTP_ID = "CTP_numero";
   ...
   // public static ArrayList<ModelPlageData> plageDataListCTP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plageDataId = intent.getStringExtra(KEY_CTP_ID);
...
*/
       ...
       if (what_to_do==3 || what_to_do==2){
           new FetchCcCTPDetailsAsyncTask().execute();
       }
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataCTP.this,
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataCTP.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageDataCTPActivity.IS_TO_CREATE_OR_TO_UPDATE){
...
//                                CreateProduitEAV.plageDataListCTP.remove(Integer.parseInt(plageDataId));
     ...
     */
    private class FetchCcCTPDetailsAsyncTask extends AsyncTask<String, String, String> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            //Display progress bar
...
//                    baseEditText.setText(base);
    ...
    private void savePlageForCreateCTP(){
    ...
    private void savePlageForUpdateCTP(){

            HttpJsonParser httpJsonParser = new HttpJsonParser();
            Map<String, String> httpParams = new HashMap<>();
            //Populating request parameters
           // httpParams.put(KEY_CTP_ID, uxGuichetId);
            ...
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "add_ctp_plage_data.php", "POST", httpParams);
        try {
            success = jsonObject.getInt(KEY_SUCCESS);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void updatePlageForUpdate(){
            ...
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "update_tiv_plage_data.php", "POST", httpParams); //Idem pour les plages CTP
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataCTP.this);
        ...
        protected String doInBackground(String... params) {
           ...
           if (ListPlageDataCTPActivity.IS_TO_CREATE_OR_TO_UPDATE){
               savePlageForCreateCTP();
           }else{
               savePlageForUpdateCTP();
           }
            return null;
        }
