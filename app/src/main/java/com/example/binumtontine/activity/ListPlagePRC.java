...
public class ListPlagePRC extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="PRC"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlagePRC.this, PlageDataPRC.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                for (int i = 0; i < CreateProduitCredit.plageDataListPRC.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCredit.plageDataListPRC.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCredit.plageDataListPRC.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListPRC.get(i).getPdValA()+
                            "( " +defaultFormat.format(parseDouble(CreateProduitCredit.plageDataListPRC.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCredit.plageDataListPRC.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListPRC.get(i).getPdValA()+
                            "( "+parseDouble(CreateProduitCredit.plageDataListPRC.get(i).getPdValTaux())+" %)";
...
private class FetchListPlageAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlagePRC.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataPRC.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataPRC.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataPRC.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlagePRC.this,
