...
public class PlageDataFEC_NEW extends AppCompatActivity implements  SERVER_ADDRESS {
   ...
   // public static ArrayList<ModelPlageData> plageDataListIRA;
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataFEC_NEW.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageFEC.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
...
//                    baseEditText.setText(base);
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataFEC_NEW.this);
