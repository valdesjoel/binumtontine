...
public class ListPlageTPT extends AppCompatActivity implements SERVER_ADDRESS {

    private static final String KEY_SUCCESS = "success";
    private static final String KEY_DATA = "data";
    private static final String KEY_TAS_ID = "Numero";
    private static final String KEY_TAS_LIBELLE = "Libelle";
    private static final String KEY_EAT_ID = "EtNumero"; // Idem pour tous les eav
    ...
    public static String pdTypeData="TPT"; //nouveau
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eatId = intent.getStringExtra(KEY_EAT_ID); //Utiliser pour les mises à jours
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(ListPlageTPT.this, PlageDataTPT.class);
    ...
    private void loadPlageForCreateTxIntAvancSpec(){
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < CreateProduitEAT.plageDataListTPT.size(); i++) {
                    // JSONObject movie = movies.getJSONObject(i);
                    Integer movieId = i;
                    String movieName ="";
                    if (CreateProduitEAT.plageDataListTPT.get(i).getPdNature().equals("F")){
                        movieName = CreateProduitEAT.plageDataListTPT.get(i).getPdValDe()+
                                CreateProduitEAT.plageDataListTPT.get(i).getPdValA()+
                                " ( "+ defaultFormat.format(parseDouble(CreateProduitEAT.plageDataListTPT.get(i).getPdValTaux()))+" )";
                    }else{
                        movieName = CreateProduitEAT.plageDataListTPT.get(i).getPdValDe()+
                                CreateProduitEAT.plageDataListTPT.get(i).getPdValA()+
                                " ( "+ parseDouble(CreateProduitEAT.plageDataListTPT.get(i).getPdValTaux())+" %)";
    ...
    private void loadPlageForUpdateTAS(){
        ...
        JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                BASE_URL + "fetch_all_plage_eat.php", "GET", httpParams);
    ...
    private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ListPlageTPT.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataTPT.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataTPT.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataTPT.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageTPT.this,
