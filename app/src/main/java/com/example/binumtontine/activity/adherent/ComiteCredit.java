...
public class ComiteCredit extends AppCompatActivity implements AdapterView.OnItemSelectedListener, SERVER_ADDRESS {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_comite_credit);


        Intent intent = getIntent();
        compteId = intent.getStringExtra(KEY_COMPTE_ID);

        Toast.makeText(ComiteCredit.this,
                compteId,
...
*/
    ...
    private void populateSpinner() {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(ComiteCredit.this,
    ...
    private class GetProduitEAVList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialogFetchProduitEavList = new ProgressDialog(ComiteCredit.this);
...
//                new AddEavAdherentAsyncTask().execute();
    ...
    private class AddEavAdherentAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ComiteCredit.this);
