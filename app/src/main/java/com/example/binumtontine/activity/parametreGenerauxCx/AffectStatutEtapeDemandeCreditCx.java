...
public class AffectStatutEtapeDemandeCreditCx extends AppCompatActivity implements AdapterView.OnItemSelectedListener, SERVER_ADDRESS {
    ...
    private static final String KEY_SE_CAISSE = "SeCaisse";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerStatutEtapeDemandeCreditTextView.setText("Affectation du statut de l'étape de demande de créditt");
...
//        alreadyUpperCase(SeLibelleEditText);
        ...
        spinnerSeEtapeDem.setOnItemSelectedListener(AffectStatutEtapeDemandeCreditCx.this);
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(AffectStatutEtapeDemandeCreditCx.this,
    ...
    private class FetchStatutEtapeDetailsAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(AffectStatutEtapeDemandeCreditCx.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    SeCode = guichet.getString(KEY_SE_CODE);
...
//                    spinnerSeEtapeDem.setText(LibelleEtape); //pas indispensable car on le fait directement dans populate
    ...
    private void confirmDelete() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                AffectStatutEtapeDemandeCreditCx.this);
    ...
    private class GetEtapeDemandeCreditList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialogFetchProduitCreditList = new ProgressDialog(AffectStatutEtapeDemandeCreditCx.this);
    ...
    private class UpdateObjetCreditAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            //Display progress bar
            pDialog = new ProgressDialog(AffectStatutEtapeDemandeCreditCx.this);
            pDialog.setMessage("Affecting Statut Crédit. Please wait...");
            pDialog.setIndeterminate(false);
            pDialog.setCancelable(false);
            pDialog.show();
        ...
        protected String doInBackground(String... params) {
           ...
           // httpParams.put(KEY_GUICHET_ID, statutEtapeDemandeCreditID);
            ...
            httpParams.put(KEY_SE_CAISSE, String.valueOf(MyData.CAISSE_ID));
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "affect_statut_etape_demande_credit_cx.php", "POST", httpParams);
            try {
                success = jsonObject.getInt(KEY_SUCCESS);
            } catch (JSONException e) {
                e.printStackTrace();
...
//    }
    ...
    private void populateSpinner() {
        ...
        // Creating adapter for spinner
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(AffectStatutEtapeDemandeCreditCx.this,
                android.R.layout.simple_spinner_item, lables);
