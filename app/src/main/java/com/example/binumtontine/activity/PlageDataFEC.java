...
public class PlageDataFEC extends AppCompatActivity implements  SERVER_ADDRESS {
   ...
   // public static ArrayList<ModelPlageData> plageDataListCTP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plageDataId = intent.getStringExtra(KEY_FEC_ID);
...
*/
       ...
       if (what_to_do==3 || what_to_do==2){
           new FetchCrFECDetailsAsyncTask().execute();
       }
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataFEC.this,
...
//            JoMtDemarrEditText.setText(valueNew+"");
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataFEC.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageDataFECActivity.IS_TO_CREATE_OR_TO_UPDATE){
...
//                                CreateProduitEAV.plageDataListCTP.remove(Integer.parseInt(plageDataId));
     ...
     */
    private class FetchCrFECDetailsAsyncTask extends AsyncTask<String, String, String> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            //Display progress bar
...
//h3 = (valeurFinEditText.getText().toString()).replaceAll(",", "").trim();
    ...
    private void savePlageForCreateFEC(){
    ...
    private void savePlageForUpdateFEC(){

            HttpJsonParser httpJsonParser = new HttpJsonParser();
            Map<String, String> httpParams = new HashMap<>();
            //Populating request parameters
           // httpParams.put(KEY_FEC_ID, uxGuichetId);
    ...
    private void updatePlageForUpdate(){
            ...
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "update_tiv_plage_data.php", "POST", httpParams); //Idem pour les plages FEC
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataFEC.this);
        ...
        protected String doInBackground(String... params) {
           ...
           if (ListPlageDataFECActivity.IS_TO_CREATE_OR_TO_UPDATE){
               savePlageForCreateFEC();
           }else{
               savePlageForUpdateFEC();
           }
            return null;
        }
