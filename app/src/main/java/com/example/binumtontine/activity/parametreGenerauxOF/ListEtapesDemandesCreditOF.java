...
public class ListEtapesDemandesCreditOF extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.activity_list_etapes_demande_credit);
        ...
        new ListEtapesDemandesCreditOF.FetchMoviesAsyncTask().execute();
...
//        getActionBar().setTitle("OBJET CREDIT");
        getSupportActionBar().setTitle("LISTE DES ETAPES");

        FloatingActionButton fab = findViewById(R.id.fab_produitEAV);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar.make(view, "Ajouter une étape de demande de crédit", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
                Intent i = new Intent(ListEtapesDemandesCreditOF.this, CreateEtapeDemandeCreditOf.class);
...
private class FetchMoviesAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListEtapesDemandesCreditOF.this);
    ...
    protected String doInBackground(String... params) {
        ...
        JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                BASE_URL + "fetch_all_etapes_demande_credit_of.php", "GET", null);
        try {
    ...
    private void populateMovieList() {
        ListAdapter adapter = new SimpleAdapter(
                ListEtapesDemandesCreditOF.this, movieList,
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            UpdateEtapeDemandeCreditOF.class);
                    intent.putExtra(KEY_ED_NUMERO, movieId);
                    startActivityForResult(intent, 20);

                } else {
                    Toast.makeText(ListEtapesDemandesCreditOF.this,
