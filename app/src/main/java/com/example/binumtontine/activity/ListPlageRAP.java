...
public class ListPlageRAP extends AppCompatActivity implements SERVER_ADDRESS {

    private static final String KEY_SUCCESS = "success";
    private static final String KEY_DATA = "data";
    private static final String KEY_TAS_ID = "Numero";
    private static final String KEY_TAS_LIBELLE = "Libelle";
    private static final String KEY_EAP_ID = "EpNumero"; // Idem pour Les EPNumero
    ...
    public static String pdTypeData="RAP"; //nouveau
...
/* begin */
      //  setContentView(R.layout.activity_movie_listing);
        ...
        eapId = intent.getStringExtra(KEY_EAP_ID); //Utiliser pour les mises à jours
        System.out.println("ListproduitId"+ eapId );
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageRAP.this, PlageDataRAP.class);
                i.putExtra(KEY_Produit_ID, eapId);
                System.out.println("ListproduitId"+ eapId );
...
private void loadPlageForCreateTxIntAvancSpec(){
    ...
    try {
        ...
        if (success == 1) {
            ...
            for (int i = 0; i < CreateProduitEAP.plageDataLisRAP.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitEAP.plageDataLisRAP.get(i).getPdNature().equals("F")){
                    movieName = "De:"+CreateProduitEAP.plageDataLisRAP.get(i).getPdValDe()+
                            " A - "+ CreateProduitEAP.plageDataLisRAP.get(i).getPdValA()+
                            " ( "+ defaultFormat.format(parseDouble(CreateProduitEAP.plageDataLisRAP.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = "De:"+CreateProduitEAP.plageDataLisRAP.get(i).getPdValDe()+
                            " A - "+ CreateProduitEAP.plageDataLisRAP.get(i).getPdValA()+
                            " ( "+ parseDouble(CreateProduitEAP.plageDataLisRAP.get(i).getPdValTaux())+" %)";
...
private void loadPlageForUpdateTAS(){
    ...
    httpParams.put(KEY_PD_TYPE_DATA, pdTypeData); //nouveau
        JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                BASE_URL + "fetch_all_plage_eap.php", "GET", httpParams);
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageRAP.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataRAP.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataRAP.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataRAP.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageRAP.this,
