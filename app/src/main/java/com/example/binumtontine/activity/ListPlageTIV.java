...
public class ListPlageTIV extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="TIV"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageTIV.this, PlageDataTIV.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                ...
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitEAV.plageDataListTIV.get(i).getPdNature().equals("F")){
                    movieName = "De:"+CreateProduitEAV.plageDataListTIV.get(i).getPdValDe()+
                            " A - "+ CreateProduitEAV.plageDataListTIV.get(i).getPdValA()+
                            " ( "+ defaultFormat.format(parseDouble(CreateProduitEAV.plageDataListTIV.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = "De:"+CreateProduitEAV.plageDataListTIV.get(i).getPdValDe()+
                            " A - "+ CreateProduitEAV.plageDataListTIV.get(i).getPdValA()+
                            " ( "+ parseDouble(CreateProduitEAV.plageDataListTIV.get(i).getPdValTaux())+" %)";
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageTIV.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataTIV.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataTIV.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataTIV.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageTIV.this,
