...
public class UpdateEAP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_create_produit_eav);
        ...
        headerEAVTextView = (TextView) findViewById(R.id.header_eap);
        headerEAVTextView.setText("Mise à jour EAP");

        ev_codeEditText = (EditText) findViewById(R.id.input_txt_Code_EAV);
        ev_libelleEditText = (EditText) findViewById(R.id.input_txt_LibelleEAP);
