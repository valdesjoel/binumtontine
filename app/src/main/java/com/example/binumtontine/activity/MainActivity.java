...
/*
import eav.support.design.widget.FloatingActionButton;
import eav.support.design.widget.NavigationView;
import eav.support.design.widget.Snackbar;
import eav.support.v4.view.GravityCompat;*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Paramétrages de l'organe faitier", Snackbar.LENGTH_LONG)
