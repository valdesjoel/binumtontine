...
public class Plage extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="TIT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_EtBaseTxInter)); //this is important, you must set it to set the item list
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = ProduitEAT.encodeEtBaseTxInter(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Plage.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageTIT.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = ProduitEAT.decodeEtBaseTxInter(plageData.getString(KEY_PD_BASE));
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitEAT.plageDataListTIT.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ...
        CreateProduitEAT.plageDataListTIT.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
        EtTypTxInter = CreateProduitEAT.plageDataListTIT.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitEAT.plageDataListTIT.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitEAT.plageDataListTIT.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitEAT.plageDataListTIT.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitEAT.plageDataListTIT.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(Plage.this);
