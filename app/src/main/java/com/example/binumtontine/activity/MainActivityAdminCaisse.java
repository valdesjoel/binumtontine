...
public class MainActivityAdminCaisse extends AppCompatActivity implements NotificationsFragment.OnFragmentInteractionListener {
    ...
    // and profile image
    private static final String urlNavHeaderBg = "https://api.androidhive.info/images/nav_menu_header_bg.jpg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_admin_caisse);
        toolbar = (Toolbar) findViewById(R.id.toolbar_admin_caisse);
       ...
       /* fab = (FloatingActionButton) findViewById(R.id.fab_admin_caisse);*/
       ...
       /* fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Paramétrages de la caisse", Snackbar.LENGTH_LONG)
...
//        toggleFab();  /*  *******************A activer ********* */
    ...
    private Fragment getHomeFragment() {
        switch (navItemIndex) {
            case 0:
                // home
                HomeAdminCaisseFragment homeAdminCaisseFragment = new HomeAdminCaisseFragment();
            ...
            default:
                return new HomeAdminCaisseFragment();
        }
    }
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_about_us:
                        ...
                        startActivity(new Intent(MainActivityAdminCaisse.this, AboutUsActivity.class));
                        drawer.closeDrawers();
                        return true;
...
//            Toast.makeText(getApplicationContext(), "Logout user!", Toast.LENGTH_LONG).show();
   ...
   /* public void setInteractionListener(NotificationsFragment.OnFragmentInteractionListener mListener){
        NotificationsFragment.mListener = mListener;
    }
