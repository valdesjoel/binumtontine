...
public class ListPlagePRD extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="PRD"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlagePRD.this, PlageDataPRD.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                for (int i = 0; i < CreateProduitCpteCourant.plageDataListPRD.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCpteCourant.plageDataListPRD.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCpteCourant.plageDataListPRD.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListPRD.get(i).getPdValA()+
                            defaultFormat.format(parseDouble(CreateProduitCpteCourant.plageDataListPRD.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCpteCourant.plageDataListPRD.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListPRD.get(i).getPdValA()+
                            parseDouble(CreateProduitCpteCourant.plageDataListPRD.get(i).getPdValTaux())+" %)";
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlagePRD.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataPRD.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataPRD.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataPRD.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlagePRD.this,
