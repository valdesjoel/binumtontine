...
public class ListPlageDBT extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="DBT"; //nouveau
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(ListPlageDBT.this, PlageDataDBT.class);
    ...
    private void loadPlageForCreateTxIntAvancSpec(){
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < CreateProduitEAT.plageDataListDBT.size(); i++) {
                    // JSONObject movie = movies.getJSONObject(i);
                    Integer movieId = i;
                    String movieName ="";
                    if (CreateProduitEAT.plageDataListDBT.get(i).getPdNature().equals("F")){
                        movieName = CreateProduitEAT.plageDataListDBT.get(i).getPdValDe()+
                                CreateProduitEAT.plageDataListDBT.get(i).getPdValA()+
                                " ( "+ defaultFormat.format(parseDouble(CreateProduitEAT.plageDataListDBT.get(i).getPdValTaux()))+" )";
                    }else{
                        movieName = CreateProduitEAT.plageDataListDBT.get(i).getPdValDe()+
                                CreateProduitEAT.plageDataListDBT.get(i).getPdValA()+
                                " ( "+ parseDouble(CreateProduitEAT.plageDataListDBT.get(i).getPdValTaux())+" %)";
    ...
    private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ListPlageDBT.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataDBT.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataDBT.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataDBT.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageDBT.this,
