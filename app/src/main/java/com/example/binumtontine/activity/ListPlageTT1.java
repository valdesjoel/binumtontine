...
public class ListPlageTT1 extends AppCompatActivity implements SERVER_ADDRESS {

    private static final String KEY_SUCCESS = "success";
    private static final String KEY_DATA = "data";
    private static final String KEY_TAS_ID = "Numero";
    private static final String KEY_TAS_LIBELLE = "Libelle";
    private static final String KEY_EAV_ID = "pre_numero"; // Idem pour tous les eav
    ...
    public static String pdTypeData="TT1"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageTT1.this, PlageDataTT1.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                for (int i = 0; i < CreateProduitEAV.plageDataListFCV.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitEAV.plageDataListFCV.get(i).getPdNature().equals("F")){
                    movieName = "De:"+CreateProduitEAV.plageDataListFCV.get(i).getPdValDe()+
                            " A - "+ CreateProduitEAV.plageDataListFCV.get(i).getPdValA()+
                            " ( "+ defaultFormat.format(parseDouble(CreateProduitEAV.plageDataListFCV.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = "De:"+CreateProduitEAV.plageDataListFCV.get(i).getPdValDe()+
                            " A - "+ CreateProduitEAV.plageDataListFCV.get(i).getPdValA()+
                            " ( "+ parseDouble(CreateProduitEAV.plageDataListFCV.get(i).getPdValTaux())+" %)";
...
private void loadPlageForUpdateTAS(){
    ...
    httpParams.put(KEY_PD_TYPE_DATA, pdTypeData); //nouveau
        JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                BASE_URL + "fetch_all_plage_pre_parametre_of.php", "GET", httpParams);
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageTT1.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataTT1.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataTT1.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataTT1.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageTT1.this,
