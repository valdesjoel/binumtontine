...
public class PlageDataPRD extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="PRD";
   ...
   // public static ArrayList<ModelPlageData> plageDataListPRD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_base_taux_penal_retard_decouv_simple_cpte_courant)); //this is important, you must set it to set the item list
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataPRD.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = CompteCourant.encodeCcBaseTxIntPenRetard(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataPRD.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlagePRD.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                            ...
                            if (ListPlagePRD.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
//                                CreateProduitEAV.plageDataListPRD.remove(Integer.parseInt(plageDataId));
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = CompteCourant.decodeCcBaseTxIntPenRetard(plageData.getString(KEY_PD_BASE));
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitCpteCourant.plageDataListPRD.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ModelPlageData maPlage = new ModelPlageData(PdTypeData,EtTypTxInter,
                valeur,valeurDebut,valeurFin,base,"");
        //CreateProduitEAV.plageDataListPRD.add(maPlage);
        CreateProduitCpteCourant.plageDataListPRD.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitCpteCourant.plageDataListPRD.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitCpteCourant.plageDataListPRD.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitCpteCourant.plageDataListPRD.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitCpteCourant.plageDataListPRD.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitCpteCourant.plageDataListPRD.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataPRD.this);
