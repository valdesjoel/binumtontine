...
public class ListPlageTCP extends AppCompatActivity implements SERVER_ADDRESS {

    private static final String KEY_SUCCESS = "success";
    private static final String KEY_DATA = "data";
    private static final String KEY_TAS_ID = "Numero";
    private static final String KEY_TAS_LIBELLE = "Libelle";
    private static final String KEY_CPTE_COURANT_ID = "CcNumero"; // Idem pour tous les cc
    ...
    public static String pdTypeData="TCP"; //nouveau
...
/* begin */
      //  setContentView(R.layout.activity_movie_listing);
        ...
        compteCourantId = intent.getStringExtra(KEY_CPTE_COURANT_ID); //Utiliser pour les mises à jours
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageTCP.this, PlageDataTCP_NEW.class);
                i.putExtra(KEY_Produit_ID, compteCourantId);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                ...
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCpteCourant.plageDataListTCP.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCpteCourant.plageDataListTCP.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListTCP.get(i).getPdValA()+
                            defaultFormat.format(parseDouble(CreateProduitCpteCourant.plageDataListTCP.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCpteCourant.plageDataListTCP.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListTCP.get(i).getPdValA()+
                            parseDouble(CreateProduitCpteCourant.plageDataListTCP.get(i).getPdValTaux())+" %)";
...
private void loadPlageForUpdateTAS(){
    ...
    httpParams.put(KEY_PD_TYPE_DATA, pdTypeData); //nouveau
        JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                BASE_URL + "fetch_all_plage_compte_courant.php", "GET", httpParams);
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageTCP.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataTCP_NEW.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataTCP_NEW.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataTCP_NEW.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageTCP.this,
