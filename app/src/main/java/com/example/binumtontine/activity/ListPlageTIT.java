...
public class ListPlageTIT extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="TIT"; //nouveau
    ...
    private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ListPlageTIT.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            Plage.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        Plage.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        Plage.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageTIT.this,
