...
public class PlageDataRAP extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="RAP";
...
//        Log.e("produitId",produitId );
      ...
      //  plageDataListCTP = new ArrayList<>();
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_EpBaseTxMtPenal)); //this is important, you must set it to set the item list
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataRAP.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = ProduitEAP.encodeEpBaseTxMtPenal(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataRAP.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageRAP.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = ProduitEAP.decodeEpBaseTxMtPenal(plageData.getString(KEY_PD_BASE));
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitEAP.plageDataLisRAP.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ...
        CreateProduitEAP.plageDataLisRAP.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitEAP.plageDataLisRAP.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitEAP.plageDataLisRAP.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitEAP.plageDataLisRAP.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitEAP.plageDataLisRAP.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitEAP.plageDataLisRAP.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataRAP.this);
