...
public class ListPlageTIP extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="TIP"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageTIP.this, PlageDataTIP.class);
...
private void loadPlageForCreateTxIntAvancSpec(){
    ...
    try {
        ...
        if (success == 1) {
            ...
            for (int i = 0; i < CreateProduitEAP.plageDataListTIP.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;

                String movieName =  CreateProduitEAP.plageDataListTIP.get(i).getPdValDe()+
                        " - "+ CreateProduitEAP.plageDataListTIP.get(i).getPdValA()+
                        " ( "+ CreateProduitEAP.plageDataListTIP.get(i).getPdValTaux()+" )";
                HashMap<String, String> map = new HashMap<String, String>();
                map.put(KEY_TAS_ID, movieId.toString());
                map.put(KEY_TAS_LIBELLE, movieName);
                movieList.add(map);
                Log.e("plageDataListTIP",movieName);
            }
        }
    } catch (Exception e) {
        e.printStackTrace();
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageTIP.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataTIP.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataTIP.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataTIP.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageTIP.this,
