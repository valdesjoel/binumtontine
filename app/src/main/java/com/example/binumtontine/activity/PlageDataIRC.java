...
public class PlageDataIRC extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="IRC";
   ...
   // public static ArrayList<ModelPlageData> plageDataListIRA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_base_taux_interet_retard_credit)); //this is important, you must set it to set the item list
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataIRC.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = Credit.encodeCrBasexInt_IntRetCred(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataIRC.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageIRC.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = Credit.decodeCrBasexInt_IntRetCred(plageData.getString(KEY_PD_BASE));
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitCredit.plageDataListIRC.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ...
        CreateProduitCredit.plageDataListIRC.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitCredit.plageDataListIRC.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitCredit.plageDataListIRC.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitCredit.plageDataListIRC.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitCredit.plageDataListIRC.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitCredit.plageDataListIRC.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataIRC.this);
