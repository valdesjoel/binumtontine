...
public class PlageDataTCP extends AppCompatActivity implements  SERVER_ADDRESS {
...
//    private static final String KEY_TCP_ID = "CTP_numero";
   ...
   // public static ArrayList<ModelPlageData> plageDataListCTP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plageDataId = intent.getStringExtra(KEY_TCP_ID);
...
*/
       ...
       if (what_to_do==3 || what_to_do==2){
           new FetchTcpDetailsAsyncTask().execute();
       }
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataTCP.this,
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataTCP.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageDataTCPActivity.IS_TO_CREATE_OR_TO_UPDATE){
...
//                                CreateProduitEAV.plageDataListCTP.remove(Integer.parseInt(plageDataId));
     ...
     */
    private class FetchTcpDetailsAsyncTask extends AsyncTask<String, String, String> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            //Display progress bar
...
//                    baseEditText.setText(base);
    ...
    private void savePlageForUpdate(){
           ...
           // httpParams.put(KEY_TCP_ID, uxGuichetId);
        ...
        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId);
            ...
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "add_tcp_plage_data.php", "POST", httpParams);
...
//        CreateProduitEAV.plageDataListCTP.add(maPlage);
    ...
    private void updatePlageForUpdate(){
            ...
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "update_tiv_plage_data.php", "POST", httpParams); //Idem pour les plages TCP
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataTCP.this);
