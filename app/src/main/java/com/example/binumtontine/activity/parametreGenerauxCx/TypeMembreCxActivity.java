...
import com.example.binumtontine.activity.parametrageGuichet.UpdateEAVForGuichet;
...
public class TypeMembreCxActivity extends AppCompatActivity implements SERVER_ADDRESS {
...
//        }
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(TypeMembreCxActivity.this, CreateProduitEAV.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_type_membre_cx, menu);
        return true;
    }
...
private class FetchProduitEAVAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(TypeMembreCxActivity.this);
    ...
    protected String doInBackground(String... params) {
        ...
        Map<String, String> httpParams = new HashMap<>();
            ...
            JSONObject jsonObject =(action_to_affect)? httpJsonParser.makeHttpRequest(
                    BASE_URL + "fetch_all_type_membre_by_caisse.php", "GET", httpParams): httpJsonParser.makeHttpRequest(
                    BASE_URL + "fetch_all_type_membre_not_affect_on_caisse.php", "GET", httpParams);
    ...
    private void populateMovieList() {
        ListAdapter adapter = new SimpleAdapter(
                TypeMembreCxActivity.this, movieList,
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                  ...
                  //  intent.putExtra(KEY_GX_NUMERO, MyData.GUICHET_ID);
                    ...
                    Toast.makeText(TypeMembreCxActivity.this,
        ...
        alertDialogBuilder.setPositiveButton("Affecter",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                            //If the user confirms deletion, execute DeleteMovieAsyncTask
                            showAddItemDialog(TypeMembreCxActivity.this);
                            //new TypeMembreCxActivity.DeleteMovieAsyncTask().execute();
                        } else {
                            Toast.makeText(TypeMembreCxActivity.this,
                                    "Impossible de se connecter à Internet",
    ...
    private class DeleteMovieAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(TypeMembreCxActivity.this);
            if (!action_to_affect){
                pDialog.setMessage("Affectation du type de membre à la caisse. Veuillez patienter...");
            }else{
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    if (success == 1) {
                        ...
                        if (!action_to_affect){
                            Toast.makeText(TypeMembreCxActivity.this,
                                    "Type membre"+" affecté à la caisse "+MyData.CAISSE_NAME, Toast.LENGTH_LONG).show();
                        }else{

                            Toast.makeText(TypeMembreCxActivity.this,
                                    "Type membre supprimé sur la caisse "+MyData.CAISSE_NAME, Toast.LENGTH_LONG).show();
                        }
                        Intent i = getIntent();
