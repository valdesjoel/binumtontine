...
public class ListGuichetActivity extends AppCompatActivity implements SERVER_ADDRESS {
...
/* begin */
      //  setContentView(R.layout.activity_movie_listing);
        ...
        new ListGuichetActivity.FetchMoviesAsyncTask().execute();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListGuichetActivity.this, CreateProduitEAV.class);
...
private class FetchMoviesAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListGuichetActivity.this);
    ...
    private void populateMovieList() {
        ListAdapter adapter = new SimpleAdapter(
                ListGuichetActivity.this, movieList,
        ...
        movieListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(ListGuichetActivity.this,
