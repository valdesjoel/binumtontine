...
public class PlageDataPAS_NEW extends AppCompatActivity implements  SERVER_ADDRESS {
    private static final String KEY_SUCCESS = "success";
    private static final String KEY_DATA = "data";
    /*Begin*/
    private static final String KEY_TAS_ID = "Numero";
    private static final String KEY_Produit_ID = "ProduitId";
    ...
    private static final String  PdTypeData="PAS";
   ...
   // public static ArrayList<ModelPlageData> plageDataListPAS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plageDataId = intent.getStringExtra(KEY_TAS_ID);
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_CcBaseTxIntPenAvceSpec)); //this is important, you must set it to set the item list
       ...
       if (what_to_do==3 || what_to_do==2){
           new FetchCcTASDetailsAsyncTask().execute();
       }
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataPAS_NEW.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = CompteCourant.encodeCcBaseTxIntPenAvceSpec(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataPAS_NEW.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlagePAS.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                            ...
                            if (ListPlagePAS.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
//                                CreateProduitEAV.plageDataListPAS.remove(Integer.parseInt(plageDataId));
     ...
     */
    private class FetchCcTASDetailsAsyncTask extends AsyncTask<String, String, String> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            //Display progress bar
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = CompteCourant.decodeCcBaseTxIntPenAvceSpec(plageData.getString(KEY_PD_BASE));
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitCpteCourant.plageDataListPAS.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ModelPlageData maPlage = new ModelPlageData(PdTypeData,EtTypTxInter,
                valeur,valeurDebut,valeurFin,base,"");
        //CreateProduitEAV.plageDataListPAS.add(maPlage);
        CreateProduitCpteCourant.plageDataListPAS.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitCpteCourant.plageDataListPAS.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitCpteCourant.plageDataListPAS.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitCpteCourant.plageDataListPAS.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitCpteCourant.plageDataListPAS.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitCpteCourant.plageDataListPAS.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataPAS_NEW.this);
        ...
        protected String doInBackground(String... params) {
           ...
           if (ListPlagePAS.IS_TO_CREATE_OR_TO_UPDATE){ // A personnaliser
               savePlageForCreateTAS();
           }else{
               savePlageForUpdateTAS();
           }
            return null;
        }
