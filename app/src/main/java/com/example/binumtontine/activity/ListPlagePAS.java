...
public class ListPlagePAS extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="PAS"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlagePAS.this, PlageDataPAS_NEW.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                for (int i = 0; i < CreateProduitCpteCourant.plageDataListPAS.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCpteCourant.plageDataListPAS.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCpteCourant.plageDataListPAS.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListPAS.get(i).getPdValA()+
                            defaultFormat.format(parseDouble(CreateProduitCpteCourant.plageDataListPAS.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCpteCourant.plageDataListPAS.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListPAS.get(i).getPdValA()+
                            parseDouble(CreateProduitCpteCourant.plageDataListPAS.get(i).getPdValTaux())+" %)";
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlagePAS.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataPAS_NEW.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataPAS_NEW.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataPAS_NEW.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlagePAS.this,
