...
public class ListPlageCAP extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="CAP"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageCAP.this, PlageDataCAP_NEW.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                ...
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCpteCourant.plageDataListCAP.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCpteCourant.plageDataListCAP.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListCAP.get(i).getPdValA()+
                            defaultFormat.format(parseDouble(CreateProduitCpteCourant.plageDataListCAP.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCpteCourant.plageDataListCAP.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListCAP.get(i).getPdValA()+
                            parseDouble(CreateProduitCpteCourant.plageDataListCAP.get(i).getPdValTaux())+" %)";
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageCAP.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataCAP_NEW.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataCAP_NEW.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataCAP_NEW.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageCAP.this,
