...
public class CreateEAV extends AppCompatActivity implements AdapterView.OnItemSelectedListener, SERVER_ADDRESS {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerListEAV = (Spinner) findViewById(R.id.spn_list_eav);
       ...
       /* tvAdherentNumDossier = (TextView) findViewById(R.id.tv_num_dossier_adherent);
        ...
        spinnerListEAV.setOnItemSelectedListener(CreateEAV.this);
    ...
    private void populateSpinner() {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(CreateEAV.this,
    ...
    private class GetProduitEAVList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialogFetchProduitEavList = new ProgressDialog(CreateEAV.this);
    ...
    private class AddEavAdherentAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(CreateEAV.this);
