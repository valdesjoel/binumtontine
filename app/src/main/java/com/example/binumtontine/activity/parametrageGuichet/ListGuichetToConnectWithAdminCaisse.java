...
public class ListGuichetToConnectWithAdminCaisse extends AppCompatActivity implements SERVER_ADDRESS {
...
/* begin */
      //  setContentView(R.layout.activity_movie_listing);
        ...
        new ListGuichetToConnectWithAdminCaisse.FetchMoviesAsyncTask().execute();
...
private class FetchMoviesAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListGuichetToConnectWithAdminCaisse.this);
    ...
    private void populateMovieList() {
        ListAdapter adapter = new SimpleAdapter(
                ListGuichetToConnectWithAdminCaisse.this, movieList,
        ...
        movieListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    MyData.GUICHET_NAME= guichetDenomination; //a revoir si c'est mieux de faire un intent.putExtra
                    Intent intent = new Intent(getApplicationContext(),
                            MainActivityUsager.class);
                    intent.putExtra(KEY_GUICHET_ID, movieId);
                    startActivityForResult(intent, 20);

                } else {
                    Toast.makeText(ListGuichetToConnectWithAdminCaisse.this,
