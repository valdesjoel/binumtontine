...
public class PlageDataPAS extends AppCompatActivity implements  SERVER_ADDRESS {
    private static final String KEY_SUCCESS = "success";
    private static final String KEY_DATA = "data";
    /*Begin*/

    private static final String KEY_PAS_ID = "Numero";
   ...
   // public static ArrayList<ModelPlageData> plageDataListCTP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plageDataId = intent.getStringExtra(KEY_PAS_ID);
...
*/
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_base_taux_int_pen_avce_spec)); //this is important, you must set it to set the item list
       ...
       if (what_to_do==3 || what_to_do==2){
           new FetchCcPASDetailsAsyncTask().execute();
       }
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataPAS.this,
...
//            JoMtDemarrEditText.setText(valueNew+"");
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataPAS.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageDataPASActivity.IS_TO_CREATE_OR_TO_UPDATE){
...
//                                CreateProduitEAV.plageDataListCTP.remove(Integer.parseInt(plageDataId));
     ...
     */
    private class FetchCcPASDetailsAsyncTask extends AsyncTask<String, String, String> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            //Display progress bar
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreatePAS(){
    ...
    private void savePlageForUpdatePAS(){

            HttpJsonParser httpJsonParser = new HttpJsonParser();
            Map<String, String> httpParams = new HashMap<>();
            //Populating request parameters
           // httpParams.put(KEY_PAS_ID, uxGuichetId);
    ...
    private void updatePlageForUpdate(){
            ...
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "update_tiv_plage_data.php", "POST", httpParams); //Idem pour les plages PAS
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataPAS.this);
        ...
        protected String doInBackground(String... params) {
           ...
           if (ListPlageDataPASActivity.IS_TO_CREATE_OR_TO_UPDATE){
               savePlageForCreatePAS();
           }else{
               savePlageForUpdatePAS();
           }
            return null;
        }
