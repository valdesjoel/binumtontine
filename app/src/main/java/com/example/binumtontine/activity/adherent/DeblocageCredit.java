...
public class DeblocageCredit extends AppCompatActivity implements AdapterView.OnItemSelectedListener, SERVER_ADDRESS {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EavDepotMinEditText = (EditText) findViewById(R.id.input_txt_DcDetailsDebl);
//        EavDepotMinEditText.addTextChangedListener(MyData.onTextChangedListener(EavDepotMinEditText));
//
        NumDossierEditText = (EditText) findViewById(R.id.input_txt_DcCodeDebl);
...
*/
    ...
    private void populateSpinner() {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(DeblocageCredit.this,
    ...
    private class GetProduitEAVList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialogFetchProduitEavList = new ProgressDialog(DeblocageCredit.this);
