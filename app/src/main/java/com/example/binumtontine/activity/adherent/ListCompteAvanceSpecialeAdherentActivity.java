...
public class ListCompteAvanceSpecialeAdherentActivity extends AppCompatActivity implements SERVER_ADDRESS {
...
//        getSupportActionBar().setTitle(adherent.getAdNom()+"\n"+adherent.getAdPrenom());
        getSupportActionBar().setTitle("Liste Avance Spec");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_home_avance_speciale_adherent, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_search:
                ...
                return true;
            case R.id.action_avance_speciale_add:
                Intent i = new Intent(ListCompteAvanceSpecialeAdherentActivity.this, OperationCompteCourant.class);
                i.putExtra(KEY_TYPE_OPERATION, "avance_speciale");
    ...
    */
    ...
    private class FetchListDecouvertAdherentAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ListCompteAvanceSpecialeAdherentActivity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            httpParams.put(KEY_TYPE_OPERATION, "A");
...
//                    //list Decouvert
                    ...
                    for (int i = 0; i < movies.length(); i++) {
                        ...
                        map.put(KEY_TYPE_COMPTE, "AVANCE SPECIALE");
