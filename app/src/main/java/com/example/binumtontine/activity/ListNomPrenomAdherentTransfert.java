...
public class ListNomPrenomAdherentTransfert extends AppCompatActivity implements SERVER_ADDRESS {
...
//    private ListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.activity_list_nom_prenom_adherent_transfert);
/* begin */
      //  setContentView(R.layout.activity_movie_listing);
        ...
        new ListNomPrenomAdherentTransfert.FetchMoviesAsyncTask().execute();
        ...
        if (sens.equals("exp")) {
            getSupportActionBar().setTitle("Expéditeur");
        }else if (sens.equals("dest")){
            getSupportActionBar().setTitle("Destinataire");
        }
        ...
        try {
            inputSearch.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                    ...
                    ListNomPrenomAdherentTransfert.this.adapter.getFilter().filter(cs);
...
private class FetchMoviesAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListNomPrenomAdherentTransfert.this);
...
//        ListAdapter adapter = new SimpleAdapter(
            adapter = new SimpleAdapter(
                    ListNomPrenomAdherentTransfert.this, movieList,
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                        ...
                        String cvMtSolde = ((TextView) view.findViewById(R.id.CvMtSolde))
                                .getText().toString();
                        if (sens.equals("exp")){
                            CreateOperationTransfertEnvoyer.TrNomExp.setText(guichetDenomination);
                            CreateOperationTransfertEnvoyer.TrPrenomExp.setText(prenom);
                            ...
                            CreateOperationTransfertEnvoyer.transfert.setTrCptEAVExp(trCptEAVExp);
                            CreateOperationTransfertEnvoyer.transfert.setCvMtSolde(cvMtSolde);
//                            CreateOperationTransfertEnvoyer.tv_solde_eav.setText(cvMtSolde);
                        ...
                        Toast.makeText(ListNomPrenomAdherentTransfert.this,
