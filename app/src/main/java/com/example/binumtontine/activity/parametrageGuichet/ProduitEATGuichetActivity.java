...
public class ProduitEATGuichetActivity extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    private static final String KEY_CAISSE_ID = "EtCaisseId";
    private static final String KEY_GX_NUMERO = "EtGuichetId";
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ProduitEATGuichetActivity.this, CreateProduitEAV.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_all:
               // new ProduitEAVGuichetActivity.FetchProduitEATAsyncTask().execute();
 ...
 */
private class FetchProduitEATAsyncTask extends AsyncTask<String, String, String> {
    @Override
    protected void onPreExecute() {
        super.onPreExecute();
        //Display progress bar
        pDialog = new ProgressDialog(ProduitEATGuichetActivity.this);
        pDialog.setMessage("Loading EAT. Please wait...");
    ...
    protected String doInBackground(String... params) {
        ...
        Map<String, String> httpParams = new HashMap<>();
            ...
            JSONObject jsonObject =(action_to_affect)? httpJsonParser.makeHttpRequest(
                    BASE_URL + "fetch_all_eat_by_guichet.php", "GET", httpParams): httpJsonParser.makeHttpRequest(
                    BASE_URL + "fetch_all_eat_not_affect_on_guichet.php", "GET", httpParams);
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < movies.length(); i++) {
                    ...
                    Integer movieId = movie.getInt(KEY_EAT_ID);
                    String movieName = movie.getString(KEY_EAT_LIBELLE);
                    HashMap<String, String> map = new HashMap<String, String>();
                    map.put(KEY_EAT_ID, movieId.toString());
                    map.put(KEY_EAT_LIBELLE, movieName);
                    movieList.add(map);
                }
            }
    ...
    private void populateMovieList() {
        ListAdapter adapter = new SimpleAdapter(
                ProduitEATGuichetActivity.this, movieList,
                R.layout.list_item, new String[]{KEY_EAT_ID,
                KEY_EAT_LIBELLE},
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            UpdateEATForGuichet.class);
                    intent.putExtra(KEY_EAT_ID, movieId);
                  ...
                  //  intent.putExtra(KEY_GX_NUMERO, MyData.GUICHET_ID);
                    ...
                    Toast.makeText(ProduitEATGuichetActivity.this,
