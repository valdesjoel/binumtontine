...
public class ListObjetCredit extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.activity_list_objet_credit);
        ...
        new ListObjetCredit.FetchMoviesAsyncTask().execute();

        Toolbar toolbar = findViewById(R.id.toolbar_produitEAV);
        setSupportActionBar(toolbar);
//        getActionBar().setTitle("OBJET CREDIT");
        getSupportActionBar().setTitle("LISTE OBJET CREDIT");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Ajouter un Objet de Crédit", Snackbar.LENGTH_LONG)
                        .setAction("Action", null).show();
                Intent i = new Intent(ListObjetCredit.this, CreateObjetCreditOf.class);
...
private class FetchMoviesAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListObjetCredit.this);
        pDialog.setMessage("Chargement des Objets de Credit. SVP Veuillez patienter...");
    ...
    protected String doInBackground(String... params) {
        ...
        JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                BASE_URL + "fetch_all_objet_credit_of.php", "GET", null);
        try {
    ...
    private void populateMovieList() {
        ListAdapter adapter = new SimpleAdapter(
                ListObjetCredit.this, movieList,
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            UpdateObjetCreditOF.class);
                    intent.putExtra(KEY_OC_NUMERO, movieId);
                    startActivityForResult(intent, 20);

                } else {
                    Toast.makeText(ListObjetCredit.this,
