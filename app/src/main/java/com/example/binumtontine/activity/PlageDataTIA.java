...
public class PlageDataTIA extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="TIA";
   ...
   // public static ArrayList<ModelPlageData> plageDataListIRA;
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataTIA.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = Credit.encodeCrBaseTxIntAn(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataTIA.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageTIA.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = Credit.decodeCrBaseTxIntAn(plageData.getString(KEY_PD_BASE));
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitCredit.plageDataListTIA.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ...
        CreateProduitCredit.plageDataListTIA.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitCredit.plageDataListTIA.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitCredit.plageDataListTIA.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitCredit.plageDataListTIA.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitCredit.plageDataListTIA.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitCredit.plageDataListTIA.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataTIA.this);
