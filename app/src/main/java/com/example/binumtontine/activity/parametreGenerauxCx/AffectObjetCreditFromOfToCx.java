...
public class AffectObjetCreditFromOfToCx extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String KEY_OC_CAISSE = "OcCaisse";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerObjetCreditTextView.setText("Affectation d'un objet de créditt");
...
//        alreadyUpperCase(OcLibelleEditText);
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(AffectObjetCreditFromOfToCx.this,
    ...
    private class FetchGuichetDetailsAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(AffectObjetCreditFromOfToCx.this);
    ...
    private void confirmDelete() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                AffectObjetCreditFromOfToCx.this);
    ...
    private class UpdateObjetCreditAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
           ...
           // httpParams.put(KEY_GUICHET_ID, objetCreditID);
            ...
            httpParams.put(KEY_OC_CAISSE, String.valueOf(MyData.CAISSE_ID));
//            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
//                    BASE_URL + "affect_objet_credit_on_cx.php", "POST", httpParams);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    if (success == 1) {
                        //Display success message
//                        Toast.makeText(AffectObjetCreditFromOfToCx.this,
//                                "Objet Crédit Affecté !", Toast.LENGTH_LONG).show();
                        Toast.makeText(AffectObjetCreditFromOfToCx.this,
