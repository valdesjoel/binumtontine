...
public class ListPlageTIC extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="TIC"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageTIC.this, PlageDataTIC_NEW.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                ...
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCredit.plageDataListTIC.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCredit.plageDataListTIC.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListTIC.get(i).getPdValA()+
                            "( " +defaultFormat.format(parseDouble(CreateProduitCredit.plageDataListTIC.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCredit.plageDataListTIC.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListTIC.get(i).getPdValA()+
                            "( "+parseDouble(CreateProduitCredit.plageDataListTIC.get(i).getPdValTaux())+" %)";
...
private class FetchListPlageAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageTIC.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataTIC_NEW.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataTIC_NEW.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataTIC_NEW.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageTIC.this,
