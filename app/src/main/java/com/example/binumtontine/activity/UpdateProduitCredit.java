        ...
        tv_plage_CrTypTxInter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    ListPlageTIC.IS_TO_CREATE_OR_TO_UPDATE = false;
        ...
        tv_plage_tia_cc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    ListPlageTIA.IS_TO_CREATE_OR_TO_UPDATE = false;
        ...
        tv_plage_cr_PenRetard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    ListPlagePRC.IS_TO_CREATE_OR_TO_UPDATE = false;
                    Intent i = new Intent(UpdateProduitCredit.this, ListPlagePRC.class);
                    startActivityForResult(i,20);
        ...
        tv_plage_cr_IntRetard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    ListPlageIRC.IS_TO_CREATE_OR_TO_UPDATE = false;
                    Intent i = new Intent(UpdateProduitCredit.this, ListPlageIRC.class);
                    startActivityForResult(i,20);
        ...
        tv_plage_CrNatFrEtudDoss.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    ListPlageFEC.IS_TO_CREATE_OR_TO_UPDATE = false;
                    Intent i = new Intent(UpdateProduitCredit.this, ListPlageFEC.class);
                    i.putExtra(KEY_CREDIT_ID, creditId);
                    startActivityForResult(i,20);
        ...
        tv_plage_CrNatFraisDeblocCred.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    ListPlageFDB.IS_TO_CREATE_OR_TO_UPDATE = false;
                    Intent i = new Intent(UpdateProduitCredit.this, ListPlageFDB.class);
                    i.putExtra(KEY_CREDIT_ID, creditId);
                    startActivityForResult(i,20);
        ...
        tv_plage_CrNatFraisDecaissCred.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    ListPlageFCX.IS_TO_CREATE_OR_TO_UPDATE = false;
                    Intent i = new Intent(UpdateProduitCredit.this, ListPlageFCX.class);
                    i.putExtra(KEY_CREDIT_ID, creditId);
                    startActivityForResult(i,20);
