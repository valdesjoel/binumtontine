...
public class PlageDataTIP extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="TIP";
...
*/
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataTIP.this,
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataTIP.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageTIP.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitEAP.plageDataListTIP.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ...
        CreateProduitEAP.plageDataListTIP.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitEAP.plageDataListTIP.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitEAP.plageDataListTIP.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitEAP.plageDataListTIP.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitEAP.plageDataListTIP.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitEAP.plageDataListTIP.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataTIP.this);
