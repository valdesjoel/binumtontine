...
public class PlageDataTIT extends AppCompatActivity implements  SERVER_ADDRESS {
   ...
   // public static ArrayList<ModelPlageData> plageDataListCTP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plageDataId = intent.getStringExtra(KEY_TIT_ID);
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataTIT.this,
...
//            JoMtDemarrEditText.setText(valueNew+"");
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataTIT.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageDataTITActivity.IS_TO_CREATE_OR_TO_UPDATE){
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTIT(){
    ...
    private void savePlageForUpdateTIT(){

            HttpJsonParser httpJsonParser = new HttpJsonParser();
            Map<String, String> httpParams = new HashMap<>();
            //Populating request parameters
           // httpParams.put(KEY_TIT_ID, uxGuichetId);
        ...
        httpParams.put(KEY_PD_PRODUIT, UpdateEAT.eatId);
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataTIT.this);
        ...
        protected String doInBackground(String... params) {
           ...
           if (ListPlageDataTITActivity.IS_TO_CREATE_OR_TO_UPDATE){
               savePlageForCreateTIT();
           }else{
               savePlageForUpdateTIT();
           }
            return null;
        }
