...
public class OperationEAP extends AppCompatActivity implements AdapterView.OnItemSelectedListener, SERVER_ADDRESS {
    ...
    private static final String KEY_CV_NUMERO = "CpNumero";
...
*/
    ...
    private void populateSpinner() {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(OperationEAP.this,
    ...
    private class GetProduitEAVList extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialogFetchProduitEavList = new ProgressDialog(OperationEAP.this);
