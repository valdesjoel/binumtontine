...
public class PlageDataFDB_NEW extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="FDB";
   ...
   // public static ArrayList<ModelPlageData> plageDataListIRA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_CrBaseTxFraisDeblocCred)); //this is important, you must set it to set the item list
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataFDB_NEW.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = Credit.encodeCrBaseTxFraisDeblocCred(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataFDB_NEW.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageFDB.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = Credit.decodeCrBaseTxFraisDeblocCred(plageData.getString(KEY_PD_BASE));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitCredit.plageDataListFDB.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ...
        CreateProduitCredit.plageDataListFDB.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitCredit.plageDataListFDB.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitCredit.plageDataListFDB.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitCredit.plageDataListFDB.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitCredit.plageDataListFDB.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitCredit.plageDataListFDB.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataFDB_NEW.this);
