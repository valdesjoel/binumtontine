...
public class ListPlageDataPASActivity extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    private String pdTypeData="PAS"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageDataPASActivity.this, PlageDataPAS.class);
...
private void loadPlageForCreateTxIntPenAvancSpec(){
    ...
    try {
        ...
        if (success == 1) {
            ...
            for (int i = 0; i < CreateProduitCpteCourant.plageDataListPAS.size(); i++) {
                ...
                String movieName =  CreateProduitCpteCourant.plageDataListPAS.get(i).getPdValDe()+
                        " - "+ CreateProduitCpteCourant.plageDataListPAS.get(i).getPdValA()+
                        " ( "+ CreateProduitCpteCourant.plageDataListPAS.get(i).getPdValTaux()+" )";
...
private void loadPlageForUpdatePAS(){
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageDataPASActivity.this);
...
if (IS_TO_CREATE_OR_TO_UPDATE){
    loadPlageForCreateTxIntPenAvancSpec();
}else loadPlageForUpdatePAS();
    ...
    protected void onPostExecute(String result) {
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                populateMovieListPlageTxIntPenAvanSpec();
            }
        });
    }
     ...
     * */
    private void populateMovieListPlageTxIntPenAvanSpec() {
        ListAdapter adapter = new SimpleAdapter(
                ListPlageDataPASActivity.this, movieList,
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataPAS.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataPAS.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataPAS.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageDataPASActivity.this,
