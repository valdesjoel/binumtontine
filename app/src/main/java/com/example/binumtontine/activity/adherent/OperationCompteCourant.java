...
public class OperationCompteCourant extends AppCompatActivity implements AdapterView.OnItemSelectedListener, SERVER_ADDRESS {
...
//        tvLibelleProduit.setText(libelleProduit);
        ...
        if (typeOperation.equals("depot")){
            ...
            tvHeaderOperationEAV.setText("DEMANDE DE DECOUVERT SIMPLE");
            ...
            compteId = ListCompteDecouvertPermanentAdherentActivity.adherent.getNumero_compte()+"";
            tvHeaderOperationEAV.setText("DEMANDE DE DECOUVERT PERMANENT");
...
*/
    ...
    private void populateSpinner() {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(OperationCompteCourant.this,
...
//    eavDepotMin = EavDepotMinEditText.getText().toString();
    ...
    private class AddEavAdherentAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(OperationCompteCourant.this);
