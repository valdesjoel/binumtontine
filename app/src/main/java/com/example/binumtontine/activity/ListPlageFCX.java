...
public class ListPlageFCX extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="FCX"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageFCX.this, PlageDataFCX_NEW.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                ...
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCredit.plageDataListFCX.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCredit.plageDataListFCX.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListFCX.get(i).getPdValA()+
                            "( " +defaultFormat.format(parseDouble(CreateProduitCredit.plageDataListFCX.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCredit.plageDataListFCX.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListFCX.get(i).getPdValA()+
                            "( "+parseDouble(CreateProduitCredit.plageDataListFCX.get(i).getPdValTaux())+" %)";
                }
...
private class FetchListPlageAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageFCX.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataFCX_NEW.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataFCX_NEW.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataFCX_NEW.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageFCX.this,
