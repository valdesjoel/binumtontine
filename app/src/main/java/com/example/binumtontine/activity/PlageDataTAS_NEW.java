...
public class PlageDataTAS_NEW extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="TAS";
   ...
   // public static ArrayList<ModelPlageData> plageDataListTAS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_CcBaseTxIntAvceSpec)); //this is important, you must set it to set the item list
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataTAS_NEW.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = CompteCourant.encodeCcBaseTxIntAvceSpec(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataTAS_NEW.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageTAS.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                            ...
                            if (ListPlageTAS.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
//                                CreateProduitEAV.plageDataListTAS.remove(Integer.parseInt(plageDataId));
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = CompteCourant.decodeCcBaseTxIntAvceSpec(plageData.getString(KEY_PD_BASE));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitCpteCourant.plageDataListTAS.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ModelPlageData maPlage = new ModelPlageData(PdTypeData,EtTypTxInter,
                valeur,valeurDebut,valeurFin,base,"");
        //CreateProduitEAV.plageDataListTAS.add(maPlage);
        CreateProduitCpteCourant.plageDataListTAS.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
            EtTypTxInter = CreateProduitCpteCourant.plageDataListTAS.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitCpteCourant.plageDataListTAS.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitCpteCourant.plageDataListTAS.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitCpteCourant.plageDataListTAS.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitCpteCourant.plageDataListTAS.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataTAS_NEW.this);
