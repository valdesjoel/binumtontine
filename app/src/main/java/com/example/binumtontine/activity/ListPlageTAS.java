...
public class ListPlageTAS extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="TAS"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageTAS.this, PlageDataTAS_NEW.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                ...
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCpteCourant.plageDataListTAS.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCpteCourant.plageDataListTAS.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListTAS.get(i).getPdValA()+
                            defaultFormat.format(parseDouble(CreateProduitCpteCourant.plageDataListTAS.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCpteCourant.plageDataListTAS.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListTAS.get(i).getPdValA()+
                            parseDouble(CreateProduitCpteCourant.plageDataListTAS.get(i).getPdValTaux())+" %)";
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageTAS.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataTAS_NEW.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataTAS_NEW.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataTAS_NEW.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageTAS.this,
