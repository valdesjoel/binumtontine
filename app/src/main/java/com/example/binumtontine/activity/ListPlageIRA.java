...
public class ListPlageIRA extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="IRA"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageIRA.this, PlageDataIRA.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                for (int i = 0; i < CreateProduitCpteCourant.plageDataListIRA.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCpteCourant.plageDataListIRA.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCpteCourant.plageDataListIRA.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListIRA.get(i).getPdValA()+
                            defaultFormat.format(parseDouble(CreateProduitCpteCourant.plageDataListIRA.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCpteCourant.plageDataListIRA.get(i).getPdValDe()+
                            CreateProduitCpteCourant.plageDataListIRA.get(i).getPdValA()+
                            parseDouble(CreateProduitCpteCourant.plageDataListIRA.get(i).getPdValTaux())+" %)";
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageIRA.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataIRA.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataIRA.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataIRA.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageIRA.this,
