...
public class ListPlageNTP extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="NTP"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageNTP.this, PlageDataNTP.class);
...
private void loadPlageForCreateTxIntAvancSpec(){
    ...
    try {
        ...
        if (success == 1) {
            ...
            for (int i = 0; i < CreateProduitEAP.plageDataLisNTP.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitEAP.plageDataLisNTP.get(i).getPdNature().equals("F")){
                    movieName = "De:"+CreateProduitEAP.plageDataLisNTP.get(i).getPdValDe()+
                            " A - "+ CreateProduitEAP.plageDataLisNTP.get(i).getPdValA()+
                            " ( "+ defaultFormat.format(parseDouble(CreateProduitEAP.plageDataLisNTP.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = "De:"+CreateProduitEAP.plageDataLisNTP.get(i).getPdValDe()+
                            " A - "+ CreateProduitEAP.plageDataLisNTP.get(i).getPdValA()+
                            " ( "+ parseDouble(CreateProduitEAP.plageDataLisNTP.get(i).getPdValTaux())+" %)";
...
private class FetchListTxIntAvancSpecAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageNTP.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataNTP.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataNTP.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataNTP.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageNTP.this,
