...
public class ListPlageTIA extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    public static String pdTypeData="TIA"; //nouveau
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ListPlageTIA.this, PlageDataTIA.class);
    ...
    try {
        ...
        if (success == 1) {
            ...
            //Parcours la liste des plages du produit
                for (int i = 0; i < CreateProduitCredit.plageDataListTIA.size(); i++) {
                // JSONObject movie = movies.getJSONObject(i);
                Integer movieId = i;
                String movieName ="";
                if (CreateProduitCredit.plageDataListTIA.get(i).getPdNature().equals("F")){
                    movieName = CreateProduitCredit.plageDataListTIA.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListTIA.get(i).getPdValA()+
                            "( " +defaultFormat.format(parseDouble(CreateProduitCredit.plageDataListTIA.get(i).getPdValTaux()))+" )";
                }else{
                    movieName = CreateProduitCredit.plageDataListTIA.get(i).getPdValDe()+
                            CreateProduitCredit.plageDataListTIA.get(i).getPdValA()+
                            "( "+parseDouble(CreateProduitCredit.plageDataListTIA.get(i).getPdValTaux())+" %)";
...
private class FetchListPlageAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        pDialog = new ProgressDialog(ListPlageTIA.this);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PlageDataTIA.class);
                    if (IS_TO_CREATE_OR_TO_UPDATE){
                        PlageDataTIA.what_to_do=2;  //Pour la mise à jour d'un produit en cours d'enregistrement
                    }else{
                        PlageDataTIA.what_to_do=3; //Pour la mise à jour d'un produit déjà enregistré
                    }
                    ...
                    Toast.makeText(ListPlageTIA.this,
