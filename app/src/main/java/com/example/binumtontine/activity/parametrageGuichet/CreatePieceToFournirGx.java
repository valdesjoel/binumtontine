...
public class CreatePieceToFournirGx extends AppCompatActivity implements SERVER_ADDRESS {
       ...
       /* Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_create_produit_eav);
        ...
        spinnerFonctionFrais.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position,
                ...
                // your stuff here
                FcCategAdh = spinnerFonctionFrais.getSelectedItem().toString();
...
//                }
       ...
       // deleteButton.setVisibility(View.GONE);
        ...
        if (action_to_affect){
            headerEAVTextView.setText("Affectation de la pièce au guichet");
...
//                    :
//                    httpJsonParser.makeHttpRequest(
//                            BASE_URL + "get_piece_gx_details.php", "GET", httpParams);
            try {
...
//}else{
    ...
    rbFpIsPieceObligNon.setChecked(!FpIsPieceOblig);
                    if (FcCategAdh!=null){
                        ...
                        ArrayAdapter<String> spinnerFraisAdapter = new ArrayAdapter<String>(CreatePieceToFournirGx.this,
...
//}
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                            ...
                            new CreatePieceToFournirGx.DeleteMovieAsyncTask().execute();
                        } else {
                            Toast.makeText(CreatePieceToFournirGx.this,
                                    "Impossible de se connecter à Internet",
                                    Toast.LENGTH_LONG).show();
    ...
    private void populateSpinner() {
        ...
        ArrayAdapter<String> spinnerGuichetAdapter = new ArrayAdapter<String>(CreatePieceToFournirGx.this,
        ...
        // Creating adapter for spinner guichet
        ArrayAdapter<String> spinnerPieceAdapter = new ArrayAdapter<String>(CreatePieceToFournirGx.this,
...
//                    BASE_URL + "add_piece_cx.php", "POST", httpParams);
            ...
            JSONObject jsonObject =(action_to_affect)?
                    httpJsonParser.makeHttpRequest(
                            BASE_URL + "assign_piece_cx_to_guichet.php", "POST", httpParams)
                    :
                    httpJsonParser.makeHttpRequest(
                            BASE_URL + "update_piece_gx.php", "POST", httpParams);
            try {
                success = jsonObject.getInt(KEY_SUCCESS);
            } catch (JSONException e) {
                e.printStackTrace();
                ...
                public void run() {
                    if (success == 1) {
                        ...
                        if (action_to_affect){
                            ...
                            Toast.makeText(CreatePieceToFournirGx.this,
                                    "Pièce modifiée", Toast.LENGTH_LONG).show();
                        }else{

                            Toast.makeText(CreatePieceToFournirGx.this,
                                    "Pièce Affectée", Toast.LENGTH_LONG).show();
                        }
                        Intent i = getIntent();
