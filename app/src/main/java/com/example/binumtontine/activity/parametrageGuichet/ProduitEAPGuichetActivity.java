...
public class ProduitEAPGuichetActivity extends AppCompatActivity implements SERVER_ADDRESS {
    ...
    private static final String KEY_GX_NUMERO = "EpGuichetId";
...
/* begin */
      //  setContentView(R.layout.activity_movie_listing);
        ...
        new FetchProduitEAPAsyncTask().execute();
        ...
        getSupportActionBar().setTitle("EAPs à affecter") ;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Intent i = new Intent(ProduitEAVActivity.this, AddMovieActivity.class);
                Intent i = new Intent(ProduitEAPGuichetActivity.this, CreateProduitEAV.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_all:
               // new ProduitEAVGuichetActivity.FetchProduitEAPAsyncTask().execute();
            ...
            case R.id.action_to_affect:
               ...
               // startActivity(new Intent(this, Help.class));
                ...
                case R.id.action_already_affect:
                    ...
                    getSupportActionBar().setTitle("EAPs déjà affectés") ;
                     new FetchProduitEAPAsyncTask().execute();
               // startActivity(new Intent(this, Help.class));
                return true;
            default:
 ...
 */
private class FetchProduitEAPAsyncTask extends AsyncTask<String, String, String> {
    @Override
    protected void onPreExecute() {
        super.onPreExecute();
        //Display progress bar
        pDialog = new ProgressDialog(ProduitEAPGuichetActivity.this);
    ...
    protected String doInBackground(String... params) {
        ...
        Map<String, String> httpParams = new HashMap<>();
            ...
            JSONObject jsonObject =(action_to_affect)? httpJsonParser.makeHttpRequest(
                    BASE_URL + "fetch_all_eap_by_guichet.php", "GET", httpParams): httpJsonParser.makeHttpRequest(
                    BASE_URL + "fetch_all_eap_not_affect_on_guichet.php", "GET", httpParams);
        ...
        try {
            ...
            if (success == 1) {
                ...
                for (int i = 0; i < movies.length(); i++) {
                    ...
                    Integer movieId = movie.getInt(KEY_EAP_ID);
                    String movieName = movie.getString(KEY_EAP_LIBELLE);
                    HashMap<String, String> map = new HashMap<String, String>();
                    map.put(KEY_EAP_ID, movieId.toString());
    ...
    private void populateMovieList() {
        ListAdapter adapter = new SimpleAdapter(
                ProduitEAPGuichetActivity.this, movieList,
                R.layout.list_item, new String[]{KEY_EAP_ID,
                KEY_EAP_LIBELLE},
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            UpdateEAPForGuichet.class);
                    intent.putExtra(KEY_EAP_ID, movieId);
                  ...
                  //  intent.putExtra(KEY_GX_NUMERO, MyData.GUICHET_ID);
                    ...
                    Toast.makeText(ProduitEAPGuichetActivity.this,
