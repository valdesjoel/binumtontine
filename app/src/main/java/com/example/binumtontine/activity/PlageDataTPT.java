...
public class PlageDataTPT extends AppCompatActivity implements  SERVER_ADDRESS {
    ...
    private static final String  PdTypeData="TPT";
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataTPT.this,
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataTPT.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageTPT.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
...
//        valeurFinEditText.setText(valeurFinEditText.getText().toString().replaceAll(",", "").trim());
    ...
    private void savePlageForCreateTAS(){
        ...
        CreateProduitEAT.plageDataListTPT.add(maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void updatePlageForCreate(){
        ...
        CreateProduitEAT.plageDataListTPT.set(Integer.parseInt(plageDataId),maPlage);
        try {
            //success = jsonObject.getInt(KEY_SUCCESS);
            success = 1;
        } catch (Exception e) {
    ...
    private void fetchPlageForCreate(){
        EtTypTxInter = CreateProduitEAT.plageDataListTPT.get(Integer.parseInt(plageDataId)).getPdNature();
        valeur = CreateProduitEAT.plageDataListTPT.get(Integer.parseInt(plageDataId)).getPdValTaux();
        valeurDebut = CreateProduitEAT.plageDataListTPT.get(Integer.parseInt(plageDataId)).getPdValDe();
        valeurFin = CreateProduitEAT.plageDataListTPT.get(Integer.parseInt(plageDataId)).getPdValA();
        base = CreateProduitEAT.plageDataListTPT.get(Integer.parseInt(plageDataId)).getPdBase();
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataTPT.this);
