...
public class JourOuvertCollecteur extends AppCompatActivity implements  View.OnClickListener,SERVER_ADDRESS {
    ...
    private static final String KEY_total_demandeRetrait = "total_demandeRetrait";
    private static final String KEY_nombreChequier1 = "nombreChequier1";
    private static final String KEY_nombreChequier2 = "nombreChequier2";
    private static final String KEY_nombrePageChequier1 = "nombrePageChequier1";
    private static final String KEY_nombrePageChequier2 = "nombrePageChequier2";
    private static final String KEY_paiementCheque = "paiementCheque";
    ...
    private TextView tv_chequier_accorde_type_1;
    private TextView tv_chequier_accorde_type_2;
    private TextView title_chequier_accorde_type_1;
    private TextView title_chequier_accorde_type_2;
    private TextView tv_paiement_cheque;
    ...
    private TextView header_tvcollecteur;
    private String nombreChequier2;
    private String nombreChequier1;
    private String nombrePageChequier1;
    private String nombrePageChequier2;
    ...
    private static final String TAG = JourOuvertCollecteur.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jour_ouvert_collecteur);
        ...
        header_tvcollecteur = (TextView) findViewById(R.id.header_tvcollecteur);
//        header_tvcollecteur.setText(MyData.COLLECTEUR_NAME);
        ...
        tv_chequier_accorde_type_1 = (TextView) findViewById(R.id.tv_chequier_accorde_type_1);
        tv_chequier_accorde_type_2 = (TextView) findViewById(R.id.tv_chequier_accorde_type_2);
        title_chequier_accorde_type_1 = (TextView) findViewById(R.id.title_chequier_accorde_type_1);
        title_chequier_accorde_type_2 = (TextView) findViewById(R.id.title_chequier_accorde_type_2);
        tv_paiement_cheque = (TextView) findViewById(R.id.tv_paiement_cheque);
        ConnexionGuichetTextView = (TextView) findViewById(R.id.tv_header_connexion_au_guichet);
        ConnexionGuichetTextView.setText("Ouverture de la journée de:"+"\n"+MyData.COLLECTEUR_NAME);
...
//                                                  });
        ...
        new JourOuvertCollecteur.FetchLastSoldeGuichetDetailsAsyncTask().execute();
    ...
    public void onClick(View v) {
        if(v == Ad_JourneeAnterieureEditText) {
            ...
            Ad_JourneeAnterieure_PickerDialog.getDatePicker().setMaxDate(System.currentTimeMillis()+24*60*60*1000);
...
//        }
    ...
    private class FetchLastSoldeGuichetDetailsAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogFetchLastSolde = new ProgressDialog(JourOuvertCollecteur.this);
            pDialogFetchLastSolde.setMessage("Loading colecteur Details. Please wait...");
...
//            httpParams.put(KEY_CG_GUICHET, String.valueOf(MyData.GUICHET_ID));
            httpParams.put(KEY_RA_USER, String.valueOf(MyData.COLLECTEUR_ID));
            /*JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "get_caisse_guichet_details.php", "GET", httpParams);*/
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "get_caisse_collecteur_details.php", "GET", httpParams);
            try {
                ...
                if (success == 1) {
                    ...
                    CgLastSolde = user.getString(KEY_total_demandeRetrait);
                    nombreChequier1 = user.getString(KEY_nombreChequier1);
                    nombreChequier2 = user.getString(KEY_nombreChequier2);
                    nombrePageChequier1 = user.getString(KEY_nombrePageChequier1);
                    nombrePageChequier2 = user.getString(KEY_nombrePageChequier2);
                    paiementCheque = user.getString(KEY_paiementCheque);
//                    CgNumero = user.getString(KEY_CM_ID);
        ...
        protected void onPostExecute(String result) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    tv_chequier_accorde_type_1.setText(nombreChequier1);
                    tv_chequier_accorde_type_2.setText(nombreChequier2);
//                    title_chequier_accorde_type_1.setText("Nombre de chequier de "+ nombrePageChequier1+" pages  accordé:");
//                    title_chequier_accorde_type_2.setText("Nombre de chequier de "+ nombrePageChequier2+" pages  accordé:");
                    title_chequier_accorde_type_1.setText("Nombre de chequier de type 1  accordé:");
                    title_chequier_accorde_type_2.setText("Nombre de chequier de type 2  accordé:");
                    tv_paiement_cheque.setText(paiementCheque);
                    ...
                    JoMtDemarrEditText.setText(CgLastSolde);
...
if (validateLogin() && valueNew<=valueLAst){
    ...
    private class AddJourOuvertAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(JourOuvertCollecteur.this);
            if(!JoIsClosed)
