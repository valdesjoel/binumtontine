...
public class PlageDataCAP_NEW extends AppCompatActivity implements  SERVER_ADDRESS {
   ...
   // public static ArrayList<ModelPlageData> plageDataListIRD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySpinnerBaseTxTIV.setItems(getResources().getStringArray(R.array.array_base_agios_cpte_courant)); //this is important, you must set it to set the item list
        ...
        annulerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Toast.makeText(PlageDataCAP_NEW.this,
    ...
    private void updatePlageData() {
        try {
            ...
            if (!STRING_EMPTY.equals(valeurEditText.getText().toString())&&
                ...
                base = CompteCourant.encodeCcNatBaseAgio(mySpinnerBaseTxTIV.getText().toString());
    ...
    private class UpdatePlageDataAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PlageDataCAP_NEW.this);
        ...
        protected String doInBackground(String... params) {
            ...
            if (ListPlageCAP.IS_TO_CREATE_OR_TO_UPDATE){ //A personnaliser
            ...
            if(what_to_do==2){
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        base = CompteCourant.decodeCcNatBaseAgio(plageData.getString(KEY_PD_BASE));
...
//        httpParams.put(KEY_PD_PRODUIT, UpdateProduitCpteCourant.cpteCourantId );
    ...
    private class InitialisationCaisseGuichetAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialogInitialisationCaisseGuichet = new ProgressDialog(PlageDataCAP_NEW.this);
