package com.example.binumtontine;
...
public class JRSpinner extends AppCompatEditText {
    ...
    /**
     * the text watcher on search my_box_stroke_color.xmlxml
     */
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (typedArray != null) {
                title = typedArray.getString(R.styleable.JRSpinner_jrs_title) == null ? "Valider" : typedArray.getString(
     ...
     * @param watcher search my_box_stroke_colorlor.xml text watcher
     */
