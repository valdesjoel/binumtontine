...
public class CreateCaisseFragment extends Fragment implements View.OnClickListener, DatePickerDialog.OnDateSetListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_create_caisse, container, false);

        mySpinner = (JRSpinner) rootView.findViewById(R.id.spn_my_spinner_localite_caisse);
        ...
        dateAgrementCx_txt = (EditText) rootView.findViewById(R.id.input_dateAgrementCx);
    ...
    private void setDateTimeField() {
        ...
        dateAgrementCx_PickerDialog = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
