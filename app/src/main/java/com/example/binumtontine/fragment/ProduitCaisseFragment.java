...
public class ProduitCaisseFragment extends Fragment implements View.OnClickListener, SERVER_ADDRESS {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_produit_caisse, container, false);
        tvEAV = (TextView) rootView.findViewById(R.id.tv_eav);
        tvEAP = (TextView) rootView.findViewById(R.id.tv_eap);
        tvEAT = (TextView) rootView.findViewById(R.id.tv_eat);

        tvFooterEAV = (TextView) rootView.findViewById(R.id.tv_footer_eav);
        tvFooterEAP = (TextView) rootView.findViewById(R.id.tv_footer_eap);
        tvFooterEAT = (TextView) rootView.findViewById(R.id.tv_footer_eat);


        produitEAVCard = (CardView) rootView.findViewById(R.id.produitEAV_card);
        produitCC_Card = (CardView) rootView.findViewById(R.id.produitCC_card);
        produitEATCard = (CardView) rootView.findViewById(R.id.produitEAT_card);
        produitEAPCard = (CardView) rootView.findViewById(R.id.produitEAP_card);
        produitTransfert_Card = (CardView) rootView.findViewById(R.id.produitTransfert_card);
        produitCredit_Card = (CardView) rootView.findViewById(R.id.produitCredit_card);

        produitTransfert_MTN_Card = (CardView) rootView.findViewById(R.id.produitTransfert_MTN_card);
        produitTransfert_ORANGE_Card = (CardView) rootView.findViewById(R.id.produitTransfert_ORANGE_card);
        produitTransfert_EU_Card = (CardView) rootView.findViewById(R.id.produitTransfert_EU_card);
        produit_Op_Ext_Card = (CardView) rootView.findViewById(R.id.produitOperation_externe_card);
        ...
        new ProduitCaisseFragment.FetchMovieDetailsAsyncTask().execute();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.produitEAV_card :
                i = new Intent(getActivity(), ProduitEAVActivity.class);
              //  i = new Intent(getActivity(), RegisterActivity.class);
                startActivity(i);
                break;
            case R.id.produitEAP_card :
                i = new Intent(getActivity(), ProduitEAPActivity.class);
                startActivity(i);
                break;
            case R.id.produitEAT_card :
                i = new Intent(getActivity(), ProduitEATActivity.class);
                startActivity(i);
                break;
            case R.id.produitCC_card :
                i = new Intent(getActivity(), ProduitCpteCourantActivity.class);
                startActivity(i);
                break;
            case R.id.produitCredit_card :
                i = new Intent(getActivity(), ProduitCreditActivity.class);
                startActivity(i);
                break;
    ...
    private class FetchMovieDetailsAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
           ...
           // pDialog = new ProgressDialog(ProduitCaisseFragment.this);
