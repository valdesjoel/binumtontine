...
public class CreateUserCaisseFragment extends Fragment implements View.OnClickListener{
    ...
    public CreateUserCaisseFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_create_user_caisse, container, false);
        mySpinner = (JRSpinner) rootView.findViewById(R.id.spn_my_spinner_caisse);

        mySpinner.setItems(getResources().getStringArray(R.array.array_caisse)); //this is important, you must set it to set the item list
        mySpinner.setTitle("Sélectionner une caisse"); //change title of spinner-dialog programmatically
