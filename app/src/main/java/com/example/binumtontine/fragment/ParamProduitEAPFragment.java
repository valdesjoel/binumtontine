...
public class ParamProduitEAPFragment extends Fragment implements View.OnClickListener{
    ...
    public ParamProduitEAPFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_param_produit_eap, container, false);
